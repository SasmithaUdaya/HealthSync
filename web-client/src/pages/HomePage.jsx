...
import api, { fetchNotifications } from "../api/api.js";
        ...
        <div className="p-6">
            ...
            <ul className="space-y-2">
              ...
              <li>
                ...
                >
                  ...
                  <span className="font-medium">AI Learning Path</span>{" "}
                  {/* Change text to something relevant */}
                </Link>
              </li>
            </ul>
          </nav>
          ...
          <div className="border-t pt-4">
            <button className="w-full flex items-center gap-3 p-3 rounded-lg hover:bg-gray-100 text-gray-700 transition-colors">
              ...
              <span onClick={logoutUser} className="font-medium">
                Logout
              </span>
            </button>
          </div>
